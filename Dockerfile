...
WORKDIR /opt/
RUN curl -L -o graylog2-server-0.92.4.tgz http://packages.graylog2.org/releases/graylog2-server/graylog2-server-0.92.4.tgz
RUN tar xf graylog2-server-0.92.4.tgz
RUN curl -L -o graylog2-web-interface-0.92.4.tgz http://packages.graylog2.org/releases/graylog2-web-interface/graylog2-web-interface-0.92.4.tgz
RUN tar xf graylog2-web-interface-0.92.4.tgz
...
RUN ln -sf /opt/graylog2-server-0.92.4 /opt/graylog2-server
...
# web-interface
RUN ln -s /opt/graylog2-web-interface-0.92.4 graylog2-web-interface
